    ...
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                <el-form-item>
                    <el-input v-model="filters.name" placeholder="模块名称" @change="selectMenu"></el-input>
                </el-form-item>
                <el-form-item>
        ...
        <el-table :data="infoList" highlight-current-row v-loading="listLoading" style="width: 100%;">
            <el-table-column prop="name" show-overflow-tooltip label="模块名称" sortable>
            </el-table-column>
...
<script>
    ...
    import { modulesList, editMenu} from '../../api/api';
