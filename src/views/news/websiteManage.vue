    ...
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                <el-form-item>
                    <el-input v-model="filters.name" placeholder="网址名称" @change="selectMenu"></el-input>
                </el-form-item>
                <el-form-item>
        ...
        <el-table :data="infoList" highlight-current-row v-loading="listLoading" style="width: 100%;">
            <el-table-column prop="name" show-overflow-tooltip label="第三方网址" sortable>
            </el-table-column>
            <el-table-column prop="url" label="第三方网址" sortable>
            </el-table-column>
        ...
        <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
                ...
                <el-form-item label="第三方网址" prop="url">
...
<script>
    ...
    import { urlList, editMenu} from '../../api/api';
    ...
    export default {
        ...
        methods: {
            ...
            getInfoList() {
                ...
                urlList(para).then((res) => {
                    this.infoList = res.data.data.urlList;
